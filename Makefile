...
regaligner_swb.debug.L64 : regaligner_swb.cc common/lib/commonlib.debug $(DEBUGDIR)/training_common.o $(DEBUGDIR)/ibm1_training.o $(DEBUGDIR)/ibm2_training.o $(DEBUGDIR)/ibm3_training.o $(DEBUGDIR)/ibm4_training.o $(DEBUGDIR)/ibm5_training.o $(DEBUGDIR)/hmm_training.o $(DEBUGDIR)/hmm_forward_backward.o common/$(DEBUGDIR)/stringprocessing.o common/$(DEBUGDIR)/combinatoric.o  $(DEBUGDIR)/alignment_computation.o $(DEBUGDIR)/singleword_fertility_training.o $(DEBUGDIR)/alignment_error_rate.o $(CBCLINK) $(DEBUGDIR)/alignment_error_rate.o $(DEBUGDIR)/corpusio.o 
	$(LINKER) $(DEBUGFLAGS) $(INCLUDE) regaligner_swb.cc common/lib/commonlib.debug $(DEBUGDIR)/training_common.o $(DEBUGDIR)/ibm1_training.o $(DEBUGDIR)/ibm2_training.o $(DEBUGDIR)/ibm3_training.o $(DEBUGDIR)/ibm4_training.o $(DEBUGDIR)/ibm5_training.o $(DEBUGDIR)/hmm_training.o $(DEBUGDIR)/hmm_forward_backward.o common/$(OPTDIR)/matrix.o  common/$(DEBUGDIR)/combinatoric.o $(DEBUGDIR)/alignment_computation.o  $(DEBUGDIR)/singleword_fertility_training.o $(DEBUGDIR)/alignment_error_rate.o $(DEBUGDIR)/corpusio.o common/$(DEBUGDIR)/fileio.o $(CBCLINK) $(GZLINK) -ldl -lm -lc -lz  -o $@

regaligner_swb.opt.L64 : regaligner_swb.cc common/lib/commonlib.opt $(OPTDIR)/training_common.o $(OPTDIR)/ibm1_training.o $(OPTDIR)/ibm2_training.o $(OPTDIR)/ibm3_training.o $(OPTDIR)/ibm4_training.o $(OPTDIR)/ibm5_training.o $(OPTDIR)/hmm_training.o $(OPTDIR)/hmm_forward_backward.o common/$(OPTDIR)/stringprocessing.o common/$(OPTDIR)/combinatoric.o  $(OPTDIR)/alignment_computation.o $(OPTDIR)/singleword_fertility_training.o $(OPTDIR)/alignment_error_rate.o  $(CBCLINK) $(OPTDIR)/alignment_error_rate.o $(OPTDIR)/corpusio.o 
	$(LINKER) $(OPTFLAGS) $(INCLUDE) regaligner_swb.cc common/lib/commonlib.debug $(OPTDIR)/training_common.o $(OPTDIR)/ibm1_training.o $(OPTDIR)/ibm2_training.o $(OPTDIR)/ibm3_training.o $(OPTDIR)/ibm4_training.o $(OPTDIR)/ibm5_training.o $(OPTDIR)/hmm_training.o $(OPTDIR)/hmm_forward_backward.o common/$(OPTDIR)/matrix.o  common/$(OPTDIR)/combinatoric.o $(OPTDIR)/alignment_computation.o  $(OPTDIR)/singleword_fertility_training.o common/$(OPTDIR)/fileio.o $(OPTDIR)/alignment_error_rate.o $(OPTDIR)/corpusio.o  $(CBCLINK) $(GZLINK) -ldl -lm -lc -lz  -o $@
